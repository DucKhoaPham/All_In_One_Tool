...
{
    public partial class FrmBarcodeMultiZonePageSetup : Form
    {
        /// <summary>
        /// 	Logger
        /// </summary>
        ...
        //private BindingSource _bSource = new BindingSource();

        public FrmBarcodeMultiZonePageSetup()
        {
            InitializeComponent();
        ...
        {
            Bitmap singlePage = BarcodeMultiZoneService.GetInstance().GenerateBitmapBarCode(
        ...
        private void btnPrintPreview_Click(object sender, EventArgs e)
        {
            try
            {
                BarcodePrintHelper.PrintPreview(
                    GetBarcodePageSetting(),
                    (string)this.cboPrinter.Items[this.cboPrinter.SelectedIndex],
                    txtBarCode.Text, GetBlockDisplayString(), Convert.ToInt16(txtNumberPage.Text));
            }
            catch (Exception ex)
            {
                _logger.Error(ex);
        ...
        private void FrmBarcodeMultiZonePageSetup_Load(object sender, EventArgs e)
        {
            try
            {
                this.txtTemplatePath.Text = BarcodeMultiZoneService.DefaultSettingsFileName;
                ...
                BarcodeMultiZoneSetting settings = BarcodeMultiZoneService.GetInstance().LoadSettings(
                ...
                {
                    BarcodeMultiZoneService.GetInstance().SaveSettings(settings,
                        this.txtTemplatePath.Text);
                }
            ...
            try
            {
                using (var frm = new FrmTemplate())
                {
                    ...
                    if (frm.ShowDialog(this) == DialogResult.OK)
                    {
                        ...
                        this.txtTemplatePath.Text = templateDetail.TemplatePath;
