...
{
    public partial class FrmBarcodeBlockUpdate : Form
    {
        /// <summary>
        /// 	Logger
        /// </summary>
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BlockSettingSelected.OffsetX = Convert.ToDouble(this.nudLocationX.Value);
                BlockSettingSelected.OffsetY = Convert.ToDouble(this.nudLocationY.Value);
                BlockSettingSelected.Width = Convert.ToDouble(this.nudBlockWidth.Value);
                BlockSettingSelected.Height = Convert.ToDouble(this.nudBlockHeight.Value);
