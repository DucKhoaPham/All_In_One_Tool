...
namespace QI.Core.Data
{
    public class SqlRepository<Entity> : ISqlRepository<Entity> where Entity : class
    {
        public readonly string connectionStringMoet;
        public readonly string connectionStringDongBo;
        public readonly string connectionStringDongBoTuyenSinhPhoThong;

        public SqlRepository(IOptionsSnapshot<AppConfigs> appConfigs)
        {
            connectionStringMoet = appConfigs.Value.ConnectionStrings.MoetDatabase;
            connectionStringDongBo = appConfigs.Value.ConnectionStrings.DongBoDatabase;
            connectionStringDongBoTuyenSinhPhoThong = appConfigs.Value.ConnectionStrings.DongBoTuyenSinhPhoThongDatabase;
        }
        ...
        {
            using (SqlConnection connection = new SqlConnection(connectionStringMoet))
            {
                connection.Open();
